...
/**
 * Created by matthew on 14/12/15.
 */
public class AccountActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_account) {
            ...
            startActivity(new Intent(AccountActivity.this, EmailActivity.class));
        } else if (id == R.id.nav_tools) {
            startActivity(new Intent(AccountActivity.this, ToolsActivity.class));
